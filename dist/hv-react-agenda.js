	...
	var HvReactAgenda = React.createClass({displayName: "HvReactAgenda",
	  ...
	  render: function() {
	    ...
	    var renderHeaderColumns = function(col, i) {
	      return (
	        React.createElement("th", {className: "agenda__cell --head"}, 
	          col.format('ddd M\/D'), 
	          React.createElement("div", null, col.format('ddd M\/D'))
	        )
	      );
	    };
	    ...
	    var renderBodyRows = function(row, i) {
	      if (i % this.props.rowsPerHour === 0) {
	        ...
	        return (
	          React.createElement("tr", {ref: ref, className: "agenda__row --hour-start"}, 
	            React.createElement("td", {className: "agenda__cell --time", rowSpan: this.props.rowsPerHour}, row.format('LT')), 
	    ...
	    return (
	      React.createElement("div", {className: "agenda"}, 
	        React.createElement("div", {ref: "scrollContainer", className: "agenda__frame"}, 
	          React.createElement("table", null, 
	            React.createElement("thead", null, 
	              React.createElement("tr", null, 
	                React.createElement("th", {className: "agenda__cell --controls"}, 
	                  React.createElement("div", {className: "agenda__prev", onClick: this.prevRange}), 
	                  React.createElement("div", {className: "agenda__next", onClick: this.nextRange})
	                ), 
